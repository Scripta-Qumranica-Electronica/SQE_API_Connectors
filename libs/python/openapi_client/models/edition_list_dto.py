...
class EditionListDTO(object):
    ...
    @property
    def editions(self):
        """Gets the editions of this EditionListDTO.  # noqa: E501


        :return: The editions of this EditionListDTO.  # noqa: E501
        :rtype: list[list[EditionDTO]]
        """
        return self._editions

    @editions.setter
    def editions(self, editions):
        """Sets the editions of this EditionListDTO.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EditionListDTO):
            return False
