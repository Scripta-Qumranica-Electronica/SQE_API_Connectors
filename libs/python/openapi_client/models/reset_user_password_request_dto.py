...
class ResetUserPasswordRequestDTO(object):
    ...
    @property
    def email(self):
        """Gets the email of this ResetUserPasswordRequestDTO.  # noqa: E501


        :return: The email of this ResetUserPasswordRequestDTO.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this ResetUserPasswordRequestDTO.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResetUserPasswordRequestDTO):
            return False
