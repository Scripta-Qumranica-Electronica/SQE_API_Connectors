# qumranica.SignInterpretationApi
...
with qumranica.ApiClient(configuration) as api_client:
    ...
    api_instance = qumranica.SignInterpretationApi(api_client)
...
update_attribute_dto = qumranica.UpdateAttributeDTO() # UpdateAttributeDTO | The details of the updated attribute (optional)
...
with qumranica.ApiClient(configuration) as api_client:
    ...
    api_instance = qumranica.SignInterpretationApi(api_client)
    edition_id = 56 # int | The ID of the edition being edited
create_attribute_dto = qumranica.CreateAttributeDTO() # CreateAttributeDTO | The details of the new attribute (optional)
...
sign_interpretation_create_dto = qumranica.SignInterpretationCreateDTO() # SignInterpretationCreateDTO | New sign interpretation data to be added (optional)
...
interpretation_attribute_create_dto = qumranica.InterpretationAttributeCreateDTO() # InterpretationAttributeCreateDTO | New details of the attribute (optional)
...
interpretation_attribute_create_dto = qumranica.InterpretationAttributeCreateDTO() # InterpretationAttributeCreateDTO | Details of the attribute to be added (optional)
...
commentary_create_dto = qumranica.CommentaryCreateDTO() # CommentaryCreateDTO | The new commentary for the sign interpretation (optional)
