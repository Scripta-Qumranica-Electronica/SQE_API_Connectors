...
with qumranica.ApiClient(configuration) as api_client:
    ...
    api_instance = qumranica.EditionApi(api_client)
...
invite_editor_dto = qumranica.InviteEditorDTO() # InviteEditorDTO | JSON object with the attributes of the new editor (optional)
...
update_editor_rights_dto = qumranica.UpdateEditorRightsDTO() # UpdateEditorRightsDTO | JSON object with the attributes of the new editor (optional)
...
with qumranica.ApiClient(configuration) as api_client:
    ...
    api_instance = qumranica.EditionApi(api_client)
    edition_id = 56 # int | Unique Id of the desired edition
edition_copy_dto = qumranica.EditionCopyDTO() # EditionCopyDTO | JSON object with the attributes to be changed in the copied edition (optional)
...
with qumranica.ApiClient(configuration) as api_client:
    ...
    api_instance = qumranica.EditionApi(api_client)
    edition_id = 56 # int | Unique Id of the desired edition
edition_update_request_dto = qumranica.EditionUpdateRequestDTO() # EditionUpdateRequestDTO | JSON object with the attributes to be updated (optional)
