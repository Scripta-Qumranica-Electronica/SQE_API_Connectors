...
class TextFragmentDataListDTO(object):
    ...
    """
    openapi_types = {
        'text_fragments': 'list[TextFragmentDataDTO]'
    }
    ...
    def __init__(self, text_fragments=None, local_vars_configuration=None):  # noqa: E501
        """TextFragmentDataListDTO - a model defined in OpenAPI"""  # noqa: E501
    ...
    def text_fragments(self):
        """Gets the text_fragments of this TextFragmentDataListDTO.  # noqa: E501


        :return: The text_fragments of this TextFragmentDataListDTO.  # noqa: E501
        :rtype: list[TextFragmentDataDTO]
        """
        return self._text_fragments

    @text_fragments.setter
    def text_fragments(self, text_fragments):
        """Sets the text_fragments of this TextFragmentDataListDTO.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TextFragmentDataListDTO):
            return False
