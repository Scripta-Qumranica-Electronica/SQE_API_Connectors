...
class SimpleImageListDTO(object):
    ...
    @property
    def images(self):
        """Gets the images of this SimpleImageListDTO.  # noqa: E501


        :return: The images of this SimpleImageListDTO.  # noqa: E501
        :rtype: list[SimpleImageDTO]
        """
        return self._images

    @images.setter
    def images(self, images):
        """Sets the images of this SimpleImageListDTO.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleImageListDTO):
            return False
