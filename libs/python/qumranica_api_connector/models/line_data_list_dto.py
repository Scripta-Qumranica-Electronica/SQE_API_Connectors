...
class LineDataListDTO(object):
    ...
    @property
    def lines(self):
        """Gets the lines of this LineDataListDTO.  # noqa: E501


        :return: The lines of this LineDataListDTO.  # noqa: E501
        :rtype: list[LineDataDTO]
        """
        return self._lines

    @lines.setter
    def lines(self, lines):
        """Sets the lines of this LineDataListDTO.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LineDataListDTO):
            return False
