...
class CreateArtefactGroupDTO(object):
    ...
    @property
    def name(self):
        """Gets the name of this CreateArtefactGroupDTO.  # noqa: E501


        :return: The name of this CreateArtefactGroupDTO.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateArtefactGroupDTO.
    ...
    @property
    def artefacts(self):
        """Gets the artefacts of this CreateArtefactGroupDTO.  # noqa: E501


        :return: The artefacts of this CreateArtefactGroupDTO.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def artefacts(self, artefacts):
        """Sets the artefacts of this CreateArtefactGroupDTO.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateArtefactGroupDTO):
            return False
