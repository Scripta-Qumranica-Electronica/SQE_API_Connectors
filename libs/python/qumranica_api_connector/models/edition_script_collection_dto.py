...
class EditionScriptCollectionDTO(object):
    ...
    """
    openapi_types = {
        'letters': 'list[CharacterShapeDTO]'
    }
    ...
    def __init__(self, letters=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def letters(self):
        """Gets the letters of this EditionScriptCollectionDTO.  # noqa: E501


        :return: The letters of this EditionScriptCollectionDTO.  # noqa: E501
        :rtype: list[CharacterShapeDTO]
        """
        return self._letters

    @letters.setter
    def letters(self, letters):
        """Sets the letters of this EditionScriptCollectionDTO.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EditionScriptCollectionDTO):
            return False
