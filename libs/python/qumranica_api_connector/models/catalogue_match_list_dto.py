...
class CatalogueMatchListDTO(object):
    ...
    """
    openapi_types = {
        'matches': 'list[CatalogueMatchDTO]'
    }
    ...
    @property
    def matches(self):
        """Gets the matches of this CatalogueMatchListDTO.  # noqa: E501


        :return: The matches of this CatalogueMatchListDTO.  # noqa: E501
        :rtype: list[CatalogueMatchDTO]
        """
        return self._matches

    @matches.setter
    def matches(self, matches):
        """Sets the matches of this CatalogueMatchListDTO.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CatalogueMatchListDTO):
            return False
