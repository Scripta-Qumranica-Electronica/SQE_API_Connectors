...
UserApi <- R6::R6Class(
  ...
  public = list(
    ...
    V1UsersGetWithHttpInfo = function(...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "UserDTO", loadNamespace("openapi")),
          error = function(e){
    ...
    V1UsersLoginPostWithHttpInfo = function(login.request.dto=NULL, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "DetailedUserTokenDTO", loadNamespace("openapi")),
          error = function(e){
             stop("Failed to deserialize response")
          }
        )
    ...
    V1UsersPutWithHttpInfo = function(user.update.request.dto=NULL, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "DetailedUserDTO", loadNamespace("openapi")),
          error = function(e){
             stop("Failed to deserialize response")
          }
        )
