...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SqeApi.InterpretationAttributeDTO();
  });
  ...
  describe('InterpretationAttributeDTO', function() {
    it('should create an instance of InterpretationAttributeDTO', function() {
      ...
      //var instane = new SqeApi.InterpretationAttributeDTO();
      //expect(instance).to.be.a(SqeApi.InterpretationAttributeDTO);
    });
