...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QumranicaApiConnector.InterpretationRoiDTO();
  });
  ...
  describe('InterpretationRoiDTO', function() {
    it('should create an instance of InterpretationRoiDTO', function() {
      // uncomment below and update the code to test InterpretationRoiDTO
      //var instane = new QumranicaApiConnector.InterpretationRoiDTO();
      //expect(instance).to.be.a(QumranicaApiConnector.InterpretationRoiDTO);
    });
