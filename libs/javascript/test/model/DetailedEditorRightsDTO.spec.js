...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QumranicaApiConnector.DetailedEditorRightsDTO();
  });
  ...
  describe('DetailedEditorRightsDTO', function() {
    it('should create an instance of DetailedEditorRightsDTO', function() {
      // uncomment below and update the code to test DetailedEditorRightsDTO
      //var instane = new QumranicaApiConnector.DetailedEditorRightsDTO();
      //expect(instance).to.be.a(QumranicaApiConnector.DetailedEditorRightsDTO);
    });
